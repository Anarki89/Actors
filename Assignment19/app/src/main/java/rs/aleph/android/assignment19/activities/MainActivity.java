package rs.aleph.android.assignment19.activities;
...
import rs.aleph.android.assignment19.adapters.DrawerListAdapter;
import rs.aleph.android.assignment19.dialogs.AboutDialog;
import rs.aleph.android.assignment19.fragments.DetailFragment;
import rs.aleph.android.assignment19.fragments.ListFragment;
import rs.aleph.android.assignment19.fragments.ListFragment.OnProductSelectedListener;
import rs.aleph.android.assignment19.model.NavigationItem;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_refresh:
                Toast.makeText(this, "Action " + getString(R.string.fragment_detal_action_refresh) + " executed.", Toast.LENGTH_LONG).show();
                break;
            case R.id.action_add:
                Toast.makeText(this, "Action " + getString(R.string.fragment_detal_action_add) + " executed.", Toast.LENGTH_LONG).show();;
                break;
        }
